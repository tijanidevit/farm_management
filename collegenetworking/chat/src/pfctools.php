...
function pfc_GetScriptFilename()
{
  ...
  {
    echo "<pre>";
    echo "<span style='color:red'>Error: pfc_GetScriptFilename function returns a wrong path. Please contact the pfc team (contact@dhavalcollege.com) and copy/paste these data to help debugging:</span>\n";
    print_r($_SERVER);
