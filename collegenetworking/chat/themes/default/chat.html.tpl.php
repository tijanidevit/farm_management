...
<?php if ($display_pfc_logo) { ?>
      <a href="http://www.dhavalcollege.com"
         id="pfc_logo"<?php if($openlinknewwindow) echo ' onclick="window.open(this.href,\'_blank\');return false;"'; ?>>
        <img src="http://www.dhavalcollege.com/pub/logo2_80x15.png" width="80" height="15"
             alt="<?php echo _pfc("Campus World CHAT", $version); ?>"
             title="<?php echo _pfc("Campus World CHAT", $version); ?>" />
      </a>
<?php } ?>
