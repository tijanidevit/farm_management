    ...
    <aside id="sidebar" class="sidebar-primary">
        ...
        <nav class="navbar">
            <ul class="navbar-nav" data-scrollable="true">
                ...
                <li class="nav-item">
                    <a href="stations.html" class="nav-link active"><i class="la la-bullseye"></i><span>Stations</span></a>
                </li>
                ...
                <div class="row">
                        ...
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/1.jpg" alt="International" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/2.jpg" alt="Network" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/3.jpg" alt="Alpha Gamma" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/4.jpg" alt="Leanne Hutton" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/5.jpg" alt="K S N F" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/6.jpg" alt="Clay Gandy" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/9.jpg" alt="Get Reehl" class="card-img--radius-md">
                                </a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-sm-4 col-6 pb-4">
                        <div class="custom-card">
                            <div class="custom-card--img">
                                <a href="javascript:void(0);">
                                    <img src="../assets/images/cover/large/10.jpg" alt="Morning one" class="card-img--radius-md">
                                </a>
                            </div>
