<?php 
    ...
    $user_savings = $conn->query("SELECT * from user_savings where saving_id = '$saving_id' ");
    $row = $user_savings->fetch_assoc();
    if (isset($_POST['profit'])) {

        $profit = $_POST['profit'];
        $update_user_savings = $conn->query("UPDATE user_savings set profit = '$profit', status = 1 where saving_id = '$saving_id' ");

        if ($update_user_savings) {           
                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $row['amount'] ?>" readonly name="">
                                    </div>
                                    <div class="form-group">
                                        <label>Amount Deposited</label>
                                        <input type="text" class="form-control" required name="profit">
                                    </div>
                                    <div class="form-group">
