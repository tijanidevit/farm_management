<?php 
    ...
    $user_withdrawals = $conn->query("SELECT * from user_withdrawals JOIN users on users.user_id = user_withdrawals.user_id order by status ");
?> 
<!DOCTYPE html>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php while ($row = $user_withdrawals->fetch_assoc()): ?>
                                                <tr>
                                                    <td><?php echo $row['username'] ?></td>
                                                    <td><?php echo $row['amount'] ?></td>
                                                    <td><?php echo $row['date_withdrawn'] ?></td>
                                                    <td>
                                                        <?php if ($row['status'] == 0): ?>
                                                            <a href="approve_withdrawal.php?withdrawal_id=<?php echo $row['withdrawal_id'] ?>">Click to approve</a>
                                                        <?php endif ?>
                                                        <?php if ($row['status'] == 1): ?>
