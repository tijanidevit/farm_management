...
$user_savings = $conn->query("SELECT * from user_savings JOIN users on users.user_id = user_savings.user_id order by status ");
?> 
<!DOCTYPE html>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                      <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php while ($row = $user_savings->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($row['status'] == 0): ?>
                                                            <a href="approve_deposit.php?saving_id=<?php echo $row['saving_id'] ?>">Click to approve</a>
                                                        <?php endif ?>
                                                        <?php if ($row['status'] == 1): ?>
