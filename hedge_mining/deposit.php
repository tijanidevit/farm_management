          ...
          <div class="cabWrapper cfix">
            ...
            <div class="cabContent" style="background-image: url(img/cabContent_back.png)">
              <div class="inner">    
                ...
                <span class="cabCaption">Deposit</span>
                <div class="accWra">
                  <div class="grid">
                            ...
                            <div class="col-md-6">
                              ...
                              <form method="post" id="deposit">
                                ...
                                <div id="result" class="alert" style="display: none;">
                                    <input type="text" readonly class="linkType4 copyLink" id="textToCopy" value="17VYtkRDiBxdtcx3cupxCyfACUw3gur4Yn" />
        ...
        if (!isNaN($('#amount').val())) {
          $.ajax({
            ...
            success: function(data){
              ...
              console.log(data);
              if (data == 1) {
                $('#output').html('<div class="alert alert-success">Hedge Mining has received your deposit. To complete your deposit, please copy and pay into the wallet below</div>');
                $('#result').show();
                $('#deposit')[0].reset();
              }
              else{
