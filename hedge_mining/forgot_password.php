                    ...
                    <div class="startTabs" style="margin: 0;">
                        <div class="contentWrap" style="background-image: url(img/modal_back.png); float: none;">
                            <div class="tabContent">
                              ...
                              <form method=post name=forgotform onsubmit="return checkform();"><input type="hidden" name="form_id" value="15950743571139"><input type="hidden" name="form_token" value="a651c642045f6591ed5d43a2acca6117">
                                <input type=hidden name=a value="forgot_password">
                                <input type=hidden name=action value="forgot_password">
                                <div class="row">
                                    <div class="item col6">
                                        <div class="inBlockType1Icon">
                                            <label for="">Type your username or e-mail<span>*</span>:</label>                            
                                            <div class="inWrap">
                                ...
                                <div class="btnFillType2Sm">
                                    <button class="innerBtn" type="submit">Forgot</button>
                                </div>
                            </form>                                
                        </div>
                    </div>        
