...
<head>
    ...
    <title>Team Page || Bizkar || Creative Multi-Purpose HTML Template</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="team-one team-one__team-page">
            <div class="container">
                ...
                <div class="text-center">
                    <a href="#" class="thm-btn team-one__more-btn">View More <i class="fa fa-angle-double-right"></i></a><!-- /.thm-btn team-one__more-btn -->
                </div><!-- /.text-center -->
            </div><!-- /.container -->
        </section><!-- /.team-one -->
        ...
        <section class="case-one case-one__team-page">
            <div class="container">
