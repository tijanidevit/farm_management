<!DOCTYPE html>
<html lang="en">
<?php $title = 'Services'; include_once 'components/head.php'; ?>
<body>
    <div class="preloader">
    ...
    <?php include_once 'components/header.php'; ?>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="service-two__block">
                            ...
                            <a href="#" class="thm-btn">View More <i class="fa fa-angle-double-right"></i></a>
                            <!-- /.thm-btn -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="faq-two__content">
                            ...
                            <a href="#" class="thm-btn faq-two__btn">Read More <i class="fa fa-angle-double-right"></i></a><!-- /.thm-btn faq-two__btn -->
                        </div><!-- /.faq-two__content -->
                    </div><!-- /.col-lg-6 -->
                    <div class="col-lg-6 d-flex justify-content-center">
                        <div class="faq-two__image">
                            <img src="assets/images/resources/faq-2-image.png" alt="">
                        </div><!-- /.faq-two__image -->
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        ...
        <section class="case-one case-one__team-page case-one__service-page">
            <div class="container">
