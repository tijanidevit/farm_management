...
$address = "wisdomintcorp@gmail.com";
...
if(!$mail->send()) 
{
	...
	echo "<p>Thank you <strong>$name</strong>, we have received your message. Expect a response from us very soon.</p>";
	echo "</div>";
	echo "</fieldset>";
