...
<head>
    ...
    <title>Register Page - Farmer</title>
                                ...
                                <div class="col-md-6 col-12 px-0">
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        ...
                                        <div class="text-center">
                                            <p> <small> Please enter your details to sign up and be part of our great farmers' community</small>
                                            </p>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <form method="post" id="registerForm">
                                                    <div class="form-group mb-50">
                                                        <label class="text-bold-600" >Fullname</label>
